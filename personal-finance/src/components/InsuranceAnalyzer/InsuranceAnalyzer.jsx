...
const InsuranceAnalyzer = () => {
  ...
  const calculateAutoInsurance = () => {
    ...
    autoInsurance.vehicles.forEach(vehicle => {
  ...
  return (
    <div className="insurance-analyzer">
      {/* Header */}
      <div className="insurance-header">
        <div className="insurance-header-content">
          <h1 className="insurance-title">Smart Insurance Analyzer</h1>
          <p className="insurance-subtitle">Comprehensive coverage analysis and optimization</p>
        </div>
      </div>

      {/* Intro Section */}
      <div className="insurance-intro-section">
