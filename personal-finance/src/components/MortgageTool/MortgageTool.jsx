  ...
  return (
    <div className="mortgage-calculator">
      ...
      <div className="mortgage-header">
        <div className="mortgage-header-content">
          <h1 className="mortgage-title">Smart Mortgage Calculator</h1>
          <p className="mortgage-subtitle">Comprehensive mortgage analysis with payment strategies and affordability insights</p>
        </div>
      </div>

      {/* Intro Section */}
      <div className="mortgage-intro-section">
