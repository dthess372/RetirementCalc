    ...
    <div className="vacation-planner">
      ...
      <div className="vacation-header">
        <div className="vacation-header-content">
          <h1 className="vacation-title">Smart Vacation Planner</h1>
          <p className="vacation-subtitle">Intelligent time-off management with predictive analytics</p>
        </div>
      </div>

      {/* Overview Section */}
      <div className="vacation-intro-section">
